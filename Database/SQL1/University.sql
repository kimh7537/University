...
create table instructor(ID varchar(5), name varchar(20) not null, dept_name varchar(20), salary numeric(8,2) check (salary > 9000), primary key (ID), foreign key (dept_name) references department (dept_name) on delete set null);
...
insert into department values ('Chemistry', 'Watson', '80000');
...
insert into instructor values ('13434', 'Smith', 'Chemistry', '57000');
...
insert into instructor values ('89374', 'Karl', 'Chemistry', '68000');
...
insert into takes values ('19991', 'MU-199', '1', 'Spring', '2018', null);
